...
[L_MAC] = KEYMAP(  // layer 0 : default
    ...
    KC_HYPR,    RGUI(A(KC_ESC)),    KC_TRNS,    KC_TRNS,    KC_LALT,
    ...
    KC_GRV,     KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_BSLS,
...
[L_NUM] = KEYMAP(
    // left hand
    KC_TRNS,      KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,            KC_F11,
    KC_TRNS,      KC_SLSH,        KC_7,           KC_8,           KC_9,           KC_EQL,           KC_LPRN,
    KC_TRNS,      S(KC_8),        KC_4,           KC_5,           KC_6,           KC_MINS,
